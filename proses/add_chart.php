...
//                 $queryUpdateCart = mysqli_query($con, "UPDATE detail_keranjang SET jumlah = '$newQuantity' WHERE id_keranjang = '$idKeranjang' AND id_barang = '$productId'");
                
//             } else {
//                 // Jika barang belum ada dalam detail_keranjang, tambahkan baru
//                 $queryAddToCart = mysqli_query($con, "INSERT INTO detail_keranjang (id_keranjang, id_barang, jumlah) VALUES ('$idKeranjang', '$productId', '$quantity')");
